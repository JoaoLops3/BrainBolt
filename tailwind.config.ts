  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "correct-answer": "hsl(var(--correct-answer))",
        "wrong-answer": "hsl(var(--wrong-answer))",
        sidebar: {
      ...
      keyframes: {
        ...
        "pulse-correct": {
          "0%, 100%": {
            backgroundColor: "hsl(var(--correct-answer))",
          },
          "50%": {
            backgroundColor: "hsl(var(--correct-answer) / 0.8)",
          },
        },
      },
      animation: {
